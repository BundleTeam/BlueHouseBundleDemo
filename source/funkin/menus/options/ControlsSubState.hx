...
import funkin.system.input.InputFormatter;
...
class ControlsSubState extends MusicBeatSubstate
{
	...
	var optionShit:Array<Dynamic> = [
		['GAMEPLAY'], ['Left', 'note_left'], ['Down', 'note_down'], ['Up', 'note_up'], ['Right', 'note_right'], ['Taunt', 'taunt'], [''], ['UI'],
	...
	override function update(elapsed:Float)
	{
		if (!rebindingKey)
		{
			...
			if (controls.RESET)
			{
				...
				keysArray[curAlt ? 1 : 0] = FlxKey.NONE;
	...
	function reloadKeys()
	{
		...
		Funkin.log('Reloaded keys: ' + ClientPrefs.keyBinds);
