...
class AchievementObject extends FlxSpriteGroup
{
	...
	public function new(savetag:String, ?camera:FlxCamera = null)
	{
		super(x, y);
		...
		var achievementIcon:FlxSprite = new FlxSprite(achievementBG.x + 10, achievementBG.y + 10).loadGraphic(Paths.image('achievements/' + savetag));
		achievementIcon.scrollFactor.set();
		achievementIcon.setGraphicSize(0, 100); // supports any icon size now -lga
