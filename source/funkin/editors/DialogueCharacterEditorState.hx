...
class DialogueCharacterEditorState extends MusicBeatState
{
	...
	override function create()
	{
		...
		tipText.setFormat(Paths.font("vcr.ttf"), 16, FlxColor.WHITE, RIGHT, QualityPrefs.textShadow(), FlxColor.BLACK);
		tipText.cameras = [camHUD];
		tipText.scrollFactor.set();
		add(tipText);

		offsetLoopText = new FlxText(10, 10, 0, '', 32);
		offsetLoopText.setFormat(Paths.font("vcr.ttf"), 32, FlxColor.WHITE, LEFT, QualityPrefs.textShadow(), FlxColor.BLACK);
		...
		offsetIdleText.setFormat(Paths.font("vcr.ttf"), 32, FlxColor.WHITE, LEFT, QualityPrefs.textShadow(), FlxColor.BLACK);
